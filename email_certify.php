...
if(isset($_GET['mb_id'])){
    ...
    //id select 해서 값을 가져온다음 db에 이메일 인증을 업뎃한다
    $sql = "SELECT * FROM member where mb_id = '$mb_id'";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_array($result);

    $sql = "UPDATE member set mb_email_certify = '1' WHERE mb_id = '$mb_id' ";
    $result = mysqli_query($conn, $sql);
    ...
    <div class="wrap">
        ...
        <div class="main">
            <div class="mainContent">
                ...
                <div class="container">
                    <div class="text_box">
                        <p class="text1">메일 인증이 되었습니다.</br>
                        인증이 완료되었으면 아래 버튼을 누르세요.
                        </p>
                        <input class="but3" type="button" value="돌아가기"  onClick="location.href='./register_complete.php'">
                    </div>
                </div>
            </div>
            <div class="sidebar">
